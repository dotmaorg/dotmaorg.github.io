...
Contains all the parts of a select. It inherits props from the Select primitive [Root](/peoples/docs/components/select#root) part.

<ThemesPropsTable defs="selectRootPropDefs" />

### Trigger

The button that toggles the select. This component inherits props from the Select primitive [Trigger](/peoples/docs/components/select#trigger) and [Value](/peoples/docs/components/select#value) parts. It supports [common margin props](/research/docs/overview/layout#margin-props).

<ThemesPropsTable defs="selectTriggerPropDefs" />

### Content

The component that pops out when the select is open. It inherits props from the [Select.Portal primitive](/peoples/docs/components/select#portal) and [Select.Content primitive](/peoples/docs/components/select#content) parts.

<ThemesPropsTable defs="selectContentPropDefs" />

### Item

The component that contains the select items. It inherits props from the [Select.Item primitive](/peoples/docs/components/select#item) part.

### Group

Used to group multiple items. It inherits props from the [Select.Group primitive](/peoples/docs/components/select#group) part. Use in conjunction with `Select.Label` to ensure good accessibility via automatic labelling.

### Label

Used to render the label of a group, it isn't focusable using arrow keys. It inherits props from the [Select.Label primitive](/peoples/docs/components/select#label) part.

### Separator

Used to visually separate items in the Select. It inherits props from the [Select.Separator primitive](/peoples/docs/components/select#separator) part.
