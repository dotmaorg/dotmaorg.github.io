...
This component inherits props from the ScrollArea primitive [Root](/peoples/docs/components/scroll-area#root) and [Viewport](/peoples/docs/components/scroll-area#viewport) parts. It supports [common margin props](/research/docs/overview/layout#margin-props).
