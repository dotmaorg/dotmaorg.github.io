...
This component inherits props from the [Checkbox primitive](/peoplesdocs/components/checkbox) and supports [common margin props](/research/docs/overview/layout#margin-props).
