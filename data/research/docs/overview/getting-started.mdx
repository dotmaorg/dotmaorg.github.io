...
Configuration is managed and applied via the [Theme](/research/docs/components/theme) component.

### Basic configuration

Pass [configuration](/research/docs/components/theme) to the `Theme` to customize appearance.
...
`ThemePanel` is a drop-in component that allows you to preview the theme in real time. Visit the [component playground](/research/playground) to see it in action.
  ...
  <Grid columns={{ initial: '1', xs: '2' }} my="6" gap="4">
      ...
      />
       ...
       <ThemesLinkCard
        ...
        href="/research/docs/theme/dark-mode"
      />
