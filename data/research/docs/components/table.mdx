...
Groups the `Header` and `Body` parts. This component is based on the `table` element and supports [common margin props](/research/docs/overview/layout#margin-props).
