...
Use [Text](/research/docs/components/text) and [Heading](/research/docs/components/heading) components to render titles and body copy. These components share `size` and `weight` props and map to the underlying type system to ensure consistent typography throughout your app.
...
Compose formatting components to add [emphasis](/research/docs/components/em), [signal importance](/research/docs/components/strong), present [code](/research/docs/components/code) and more.
...
The following weights are supported. Weights can be [customized](/research/docs/theme/typography#custom-font-weights) to map to your own typeface.
...
Be aware that you may encounter css import order issues if you are running the app router. See [common styling issues](/research/docs/overview/styling#nextjs-import-order) for more information.
