...
This component is based on the [Navigation Menu primitive](/peoples/docs/components/navigation-menu) and supports [common margin props](/research/docs/overview/layout#margin-props).
