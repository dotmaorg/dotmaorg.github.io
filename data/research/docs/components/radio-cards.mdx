...
This component inherits props from the [Radio Group primitive](/peoples/docs/components/radio-group) and supports [common margin props](/research/docs/overview/layout#margin-props).
