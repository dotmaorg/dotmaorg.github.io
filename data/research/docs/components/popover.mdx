...
This component inherits props from the [Popover primitive](/peoples/docs/components/popover).
...
Use the [Inset](/research/docs/components/inset) component to align content flush with the sides of the popover.
