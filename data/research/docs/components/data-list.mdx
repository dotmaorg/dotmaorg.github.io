...
This component is based on the `dl` element and supports [common margin props](/research/docs/overview/layout#margin-props).
...
Use the `color` prop on the Label part to assign a specific [color](/research/docs/theme/color).
