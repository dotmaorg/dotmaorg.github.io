...
This component inherits props from the [Context Menu primitive](/peoples/docs/components/context-menu).
...
Use the `color` prop to assign a specific [color](/research/docs/theme/color). You can also pass `color` to a specific item to override for semantic reasons (i.e. a destructive action).
