...
This component inherits props from the [Separator primitive](/peoples/docs/components/separator) and supports [common margin props](/research/docs/overview/layout#margin-props).
