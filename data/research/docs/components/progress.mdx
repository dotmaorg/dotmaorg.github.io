...
This component inherits props from the [Progress primitive](/peoples/docs/components/progress) and supports [common margin props](/research/docs/overview/layout#margin-props).
