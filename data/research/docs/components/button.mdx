...
This component is based on the `button` element and supports [common margin props](/research/docs/overview/layout#margin-props).
...
Use the `color` prop to assign a specific [color](/research/docs/theme/color).
...
If you have an icon inside the button, you can use the button’s `disabled` state and wrap the icon in a standalone [Spinner](/research/docs/components/spinner) to achieve a more sophisticated design.
