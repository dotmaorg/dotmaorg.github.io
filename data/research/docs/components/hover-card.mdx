...
This component inherits props from the [Hover Card primitive](/peoplesdocs/components/hover-card).
...
Use the [Inset](/research/docs/components/inset) component to align content flush with the sides of the hover card.
