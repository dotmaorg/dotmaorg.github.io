...
This component inherits props from the [Slider primitive](/peoplesdocs/components/slider) and supports [common margin props](/research/docs/overview/layout#margin-props).
