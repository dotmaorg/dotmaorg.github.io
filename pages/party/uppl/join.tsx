			...
			<Box mx={{ initial: "5", xs: "6", sm: "7", md: "9" }} position="relative">
				...
				<Section size={{ initial: "2", md: "4" }}>
					<Container>
						...
						<Container>
							<SerifHeading mb="1" style={{ maxWidth: 920, textAlign: "center" }}>
								Join United People's Party Liberal (UPPL)
							</SerifHeading>
						</Container>
