									...
									<Box mt="6">
										<Flex gap="6">
											<Flex align="center" direction="column">
												...
												<TabNavDemo baseUrl="/research/playground" mb="5" />
												<TabNavDemo baseUrl="/research/playground" highContrast />
											</Flex>
...
function ExampleDataList({
	...
	return (
		<DataList.Root orientation={orientation} size={size} {...props}>
			...
			<DataList.Item>
				<DataList.Label minWidth="88px">Party</DataList.Label>
				<DataList.Value>
					<Link
						color="gray"
						highContrast
...
const PlaygroundSectionTitle = ({
	...
	<Flex align="baseline" gap="4" mt="2">
		...
		<NextLink passHref legacyBehavior href={`/research/docs/components/${id}`}>
