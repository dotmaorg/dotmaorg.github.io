...
export async function getStaticPaths() {
	const frontmatters = getAllFrontmatter("party/docs/palette-composition");

	return {
		paths: frontmatters.map((frontmatter) => ({
			params: {
				slug: frontmatter.slug.replace("party/docs/palette-composition/", ""),
			},
		})),
		fallback: false,
	};
...
export async function getStaticProps(
	...
	const { frontmatter, code } = await getMdxBySlug(
		"party/docs/palette-composition/",
		context.params!.slug,
	);
