...
This component inherits props from the [Dropdown Menu primitive](/peoplesdocs/components/dropdown-menu).
...
Use the `color` prop to assign a specific [color](/research/docs/theme/color). You can also pass `color` to a specific item to override for semantic reasons (ie. destruction action).
