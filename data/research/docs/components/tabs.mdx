...
This component inherits props from the [Tabs primitive](/peoples/docs/components/tabs) and supports [common margin props](/research/docs/overview/layout#margin-props).
...
Use the `color` prop to assign a specific [color](/research/docs/theme/color) to the tab list.
...
Tabs should not be used for page navigation. Use [Tab Nav](/research/docs/components/tab-nav) instead, which is designed for this purpose and has equivalent styles.
