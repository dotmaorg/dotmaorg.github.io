...
export const Footer = () => {
	...
	const isColors = router.pathname.includes("/party");
			...
			<footer>
				...
				<Box>
					...
					<ul>
						...
						<li>
							<Text as="p" size="2" mt="3">
								<NextLink href="/peoples" passHref legacyBehavior>
									<Link color="gray">Peoples and Models</Link>
								</NextLink>
							</Text>
						</li>
						<li>
							<Text as="p" size="2" mt="3">
								<NextLink href="/places" passHref legacyBehavior>
									<Link color="gray">Place Docs</Link>
								</NextLink>
							</Text>
						</li>
						<li>
						...
						<li>
							<Text as="p" size="2" mt="3">
								<NextLink href="/party" passHref legacyBehavior>
									<Link color="gray">Party</Link>
								</NextLink>
							</Text>
						</li>
					</ul>
					...
					<Box>
						...
						<ul>
							<li>
								<Text as="p" size="2" mt="3">
									<NextLink
										href="/peoples/docs/overview/introduction"
										passHref
										legacyBehavior
									>
							...
							<li>
								<Text as="p" size="2" mt="3">
									<NextLink
										href="/peoples/docs/guides/styling"
										passHref
										legacyBehavior
									>
							...
							<li>
								<Text as="p" size="2" mt="3">
									<NextLink
										href="/peoples/docs/overview/accessibility"
										passHref
										legacyBehavior
									>
							...
							<li>
								<Text as="p" size="2" mt="3">
									<NextLink
										href="/peoples/docs/overview/releases"
										passHref
										legacyBehavior
									>
					...
					<Box>
						...
						<ul>
							<li>
								<Text as="p" size="2" mt="3">
									<NextLink
										href="/party/docs/overview/about-us"
										passHref
										legacyBehavior
									>
							...
							<li>
								<Text as="p" size="2" mt="3">
									<NextLink
										href="/party/docs/palette-composition/scales"
										passHref
										legacyBehavior
									>
							...
							<li>
								<Text as="p" size="2" mt="3">
									<NextLink
										href="/party/docs/palette-composition/composing-a-palette"
										passHref
										legacyBehavior
									>
							...
							<li>
								<Text as="p" size="2" mt="3">
									<NextLink
										href="/party/docs/palette-composition/understanding-the-scale"
										passHref
										legacyBehavior
									>
