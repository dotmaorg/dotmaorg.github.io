...
This component inherits props and functionality from the [Toggle Group primitive](/peoples/docs/components/toggle-group). It supports [common margin props](/research/docs/overview/layout#margin-props).
