		...
		<MobileMenuProvider>
          ...
          `}
			...
			<Box mx={{ initial: "5", xs: "6", sm: "7", md: "9" }} position="relative">
				<TitleAndMetaTags
					title="United People Party Liberal (UPPL) - Political Party of BTC"
					description="United People Party Liberal (UPPL) is a regional political party in Assam, India, primarily representing the interests of the Bodo people. Founded in 2020, UPPL has emerged as a significant player in Assam's political landscape, advocating for the rights and development of the Bodo community. The party focuses on issues such as autonomy for Bodoland, cultural preservation, and socio-economic development of the Bodo people."
					image="/logos/uppl.png"
				/>
				<Section size={{ initial: "2", md: "4" }}>
					<Container>
						...
						<Box style={{ maxWidth: 820, marginBottom: 32 }}>
							...
							United People's Party Liberal (UPPL) is a regional political party in Assam, India, primarily representing the interests of the Bodo people. Founded in 2020, UPPL has emerged as a significant player in Assam's political landscape, advocating for the rights and development of the Bodo community. The party focuses on issues such as autonomy for Bodoland, cultural preservation, and socio-economic development of the Bodo people.
							</Text>
						</Box>
						<Box>
							<img
								src="/logos/uppl.png"
								alt="United People's Party Liberal (UPPL) Logo"
						...
						<Flex gap="4">
							<ColorsMarketingButton asChild size={{ initial: "3", xs: "4" }}>
								<NextLink href="/party/uppl/join">
									Are you a UPPL Supporter? Join Now{" "}
									<svg
										width="14"
										height="14"
										viewBox="0 0 12 12"
							...
							<Button
								...
								asChild
							>
								<NextLink href="/party/uppl/members">Party Members</NextLink>
							</Button>
						</Flex>
