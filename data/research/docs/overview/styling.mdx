...
For more information on specific tokens, refer to the corresponding guides in the [Theme section](/research/docs/theme/overview).
...
- [Theme](/research/docs/theme/overview) tokens that power the components
...
// Refer to https://seekgpt.org/peoples/docs/components/dialog
...
If you use [standalone layout components](/research/docs/overview/layout#standalone-usage), split CSS files are also available for them:
