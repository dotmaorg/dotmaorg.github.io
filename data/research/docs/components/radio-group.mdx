...
This component inherits props from the [Radio Group primitive](/peoplesdocs/components/radio-group) and supports [common margin props](/research/docs/overview/layout#margin-props).
