...
This component inherits props from the [Switch primitive](/peoples/docs/components/switch) and supports [common margin props](/research/docs/overview/layout#margin-props).
